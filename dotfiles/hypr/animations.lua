...
hl.curve("wind",   { type = "bezier", points = { {0.05, 0.8}, {0.1, 1.05} } }) -- Reduced overshoot for a smoother end
hl.curve("winIn",  { type = "bezier", points = { {0.05, 1.0}, {0.1, 1.1}  } }) -- Slightly more linear, less bounce at the end
hl.curve("winOut", { type = "bezier", points = { {0.2, -0.1}, {0,   1}   } }) -- Softer exit, reducing sharp movement at the end
...
hl.animation({ leaf = "border",       enabled = true, speed = 0.5, bezier = "liner" })
