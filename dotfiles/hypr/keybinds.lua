...
hl.bind(mainMod .. " + SHIFT + B", hl.dsp.exec_cmd(browser_incognito))
local closeWindowBind = hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.window.close())
-- closeWindowBind:set_enabled(false)
hl.bind(" + CONTROL + ALT + DELETE", hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch 'hl.dsp.exit()'"))
...
-- Taking Screenshots
hl.bind(" + Print", hl.dsp.exec_cmd(screenshot .. " output"))  -- capture active monitor
hl.bind(" + ALT + Print", hl.dsp.exec_cmd(screenshot .. " region"))  -- capture a region
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd(screenshot .. " window"))  -- capture active window
